      ...
      <div className="max-w-6xl w-full space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-muted-foreground">
            Track performance, create tests, and monitor learning outcomes
          </p>
        </div>
          ...
          <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => navigate("/parent")}>
            ...
            <CardContent>
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>• Create personalized tests</li>
          ...
          <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => navigate("/teacher")}>
            ...
            <CardContent>
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>• Create tests for entire class</li>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>View and complete tests</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
